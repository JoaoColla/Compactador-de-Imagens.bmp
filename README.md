...
Deve-se colocar a imagem ou o compactado que desejar dentro da pasta *img/* e então no arquivo *main* que escolher de acordo com a funcionalidade mudar o nome do arquivo que sera modificado, para ai sim executar o arquivo *t1.c* na sua máquina.
